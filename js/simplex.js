...
function tratar_string(string) {
	...
	string = retira_espacos(string); //Retirar espa�os em branco da String
...
// se backtrack = false, retorna -1 n�o foi encontrada
...
function extrair_array_elementos(inString, sep) {
	...
	//Array 'local' com a posi��o de separadores na String
	for (var i = 0; i < length; i++) {
...
/* ====================================================== */
/* ==== Tranformar numero decimal em Fra��o ============= */
/* ====================================================== */
